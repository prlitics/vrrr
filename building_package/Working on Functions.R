...
usethis::use_data(state_list, state_key, alabama.yaml, alaska.yaml, colorado.yaml,
                  connecticut.yaml, delaware.yaml, florida.yaml, georgia.yaml,
                  idaho.yaml, iowa.yaml, kansas.yaml, montana.yaml, newyork.yaml,
                  newjersey.yaml, northcarolina.yaml, oklahoma.yaml,
                  oregon.yaml, rhodeisland.yaml, southdakota.yaml, utah.yaml,
                  vermont.yaml, washington.yaml, westvirginia.yaml, wyoming.yaml,
